...
def initialize_firebase():
    ...
    cred = credentials.Certificate(r"C:\Users\tar30\realTimeTracking\fireBase\traffic-monitoring-f490d-firebase-adminsdk-fbsvc-f24fd8d3d3.json")  # Update with your correct path
